...
(function() {
    ...
    function makeSignatures() {
        ...
        var unknownModules = {};
        for (var i in moduleSignatures) unknownModules[i] = moduleSignatures[i];

        for (var modIndex in vivaldi.jdhooks._modules) {

            //displayName
            var fntxt = ('' + vivaldi.jdhooks._modules[modIndex]);
            ...
            for (var moduleName in moduleSignatures) {
                if (0 === moduleSignatures[moduleName].filter(function(i) {
                    ...
                    if (unknownModules[moduleName]) delete unknownModules[moduleName];
        ...
        for (var moduleName in unknownModules)
    ...
    window.webpackJsonp = function(chunkIds, modules, startupModules) {
        ...
        modules[startmodule] = function(moduleInfo, exports, nrequire) {
            ...
            if (!vivaldi.jdhooks._modules) {
                ...
                hookModule('react_React', function(moduleInfo) {
